...
#endif
{
    ...
    class_<PYCONTACT, OPENRAVE_SHARED_PTR<PYCONTACT> > contact(m, "Contact", DOXY_CLASS(CONTACT));
    contact.def(init<>());
#else
    class_<PYCONTACT, OPENRAVE_SHARED_PTR<PYCONTACT> > contact("Contact", DOXY_CLASS(CONTACT));
#endif
    contact.def_readonly("pos",&PYCONTACT::pos);
    contact.def_readonly("norm",&PYCONTACT::norm);
    contact.def_readonly("depth",&PYCONTACT::depth);
    contact.def("__str__",&PYCONTACT::__str__);
    contact.def("__unicode__",&PYCONTACT::__unicode__);

#ifdef USE_PYBIND11_PYTHON_BINDINGS
    class_<PyCollisionPairInfo, OPENRAVE_SHARED_PTR<PyCollisionPairInfo> > collisionpairinfo(m, "CollisionPairInfo", DOXY_CLASS(CollisionPairInfo));
#else
    class_<PyCollisionPairInfo, OPENRAVE_SHARED_PTR<PyCollisionPairInfo> > collisionpairinfo("CollisionPairInfo", DOXY_CLASS(CollisionPairInfo));
#endif
    collisionpairinfo.def_readonly("bodyLinkGeom1Name", &PyCollisionPairInfo::bodyLinkGeom1Name);
    collisionpairinfo.def_readonly("bodyLinkGeom2Name", &PyCollisionPairInfo::bodyLinkGeom2Name);
    collisionpairinfo.def_readonly("contacts", &PyCollisionPairInfo::contacts);
    collisionpairinfo.def("__str__",&PyCollisionPairInfo::__str__);
    collisionpairinfo.def("__unicode__",&PyCollisionPairInfo::__unicode__);
    collisionpairinfo.def("ExtractFirstBodyLinkGeomNames", &PyCollisionPairInfo::ExtractFirstBodyLinkGeomNames);
    collisionpairinfo.def("ExtractSecondBodyLinkGeomNames", &PyCollisionPairInfo::ExtractSecondBodyLinkGeomNames);

#ifdef USE_PYBIND11_PYTHON_BINDINGS
    class_<PyCollisionReport, OPENRAVE_SHARED_PTR<PyCollisionReport> > collisionreport(m, "CollisionReport", DOXY_CLASS(CollisionReport));
    collisionreport.def(init<>());
#else
    class_<PyCollisionReport, OPENRAVE_SHARED_PTR<PyCollisionReport> > collisionreport("CollisionReport", DOXY_CLASS(CollisionReport));
#endif
    collisionreport.def_readonly("collisionInfos",&PyCollisionReport::collisionInfos);
...
#ifdef USE_PYBIND11_PYTHON_BINDINGS
    class_<PyCollisionCheckerBase, OPENRAVE_SHARED_PTR<PyCollisionCheckerBase>, PyInterfaceBase> collisionchecker(m, "CollisionChecker", DOXY_CLASS(CollisionCheckerBase));
#else
    class_<PyCollisionCheckerBase, OPENRAVE_SHARED_PTR<PyCollisionCheckerBase>, bases<PyInterfaceBase> > collisionchecker("CollisionChecker", DOXY_CLASS(CollisionCheckerBase), no_init);
#endif
    ...
    collisionchecker.def("CheckCollision",pcolyl, PY_ARGS("ray","link") DOXY_FN(CollisionCheckerBase,CheckCollision "const RAY; KinBody::LinkConstPtr;"));
    collisionchecker.def("CheckCollision",pcolylr, PY_ARGS("ray","link","report") DOXY_FN(CollisionCheckerBase,CheckCollision "const RAY; KinBody::LinkConstPtr; CollisionReportPtr"));
    ...
    collisionchecker.def("CheckCollision",pcoll, PY_ARGS("link") DOXY_FN(CollisionCheckerBase,CheckCollision "KinBody::LinkConstPtr; CollisionReportPtr"));  // must follow the other 1-arg overloads; this function overload matches generic (object) signatures
    ...
    collisionchecker.def("CheckCollision",pcolll, PY_ARGS("link1","link2") DOXY_FN(CollisionCheckerBase,CheckCollision "KinBody::LinkConstPtr; KinBody::LinkConstPtr; CollisionReportPtr"));  // must follow the other 2-arg overloads; this function overload matches generic (object) signatures
    ...
    collisionchecker.def("CheckCollision",pcolle, PY_ARGS("link","bodyexcluded","linkexcluded") DOXY_FN(CollisionCheckerBase,CheckCollision "KinBody::LinkConstPtr; const std::vector; const std::vector; CollisionReportPtr"));  // must follow the other 3-arg overloads; this function overload matches generic (object) signatures
